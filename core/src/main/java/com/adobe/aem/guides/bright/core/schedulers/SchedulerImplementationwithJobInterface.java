package com.adobe.aem.guides.bright.core.schedulers;
...
import com.adobe.aem.guides.bright.core.config.SchedulerConfigurationForCronJob;
...
public class SchedulerImplementationwithJobInterface implements Job {
    private static final Logger LOG = LoggerFactory.getLogger(SchedulerImplementationwithJobInterface.class);
