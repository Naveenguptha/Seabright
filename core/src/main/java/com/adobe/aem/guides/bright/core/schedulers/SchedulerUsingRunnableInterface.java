...
public class SchedulerUsingRunnableInterface implements Runnable {
    private static final Logger LOG = LoggerFactory.getLogger(SchedulerUsingRunnableInterface.class);
