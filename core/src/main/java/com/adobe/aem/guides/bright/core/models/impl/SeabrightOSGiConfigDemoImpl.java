...
import com.adobe.aem.guides.bright.core.models.SeabrightOSGiConfigDemo;
import com.adobe.aem.guides.bright.core.models.SeabrightServiceDemo;
import com.adobe.aem.guides.bright.core.services.SeabrightOSGiConfig;
...
@Model(adaptables = SlingHttpServletRequest.class, adapters = SeabrightOSGiConfigDemo.class, defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL)
public class SeabrightOSGiConfigDemoImpl implements SeabrightOSGiConfigDemo {

	/*--------Start Tutorial #31--------*/
	@OSGiService
	SeabrightOSGiConfig oSGiConfig;
	...
	OSGiFactoryConfig oSGiFactoryConfig;
	  ...
	  public List<OSGiFactoryConfig> getAllOSGiConfigs()  { 
		  return	 
				  oSGiFactoryConfig.getAllConfigs(); } 
