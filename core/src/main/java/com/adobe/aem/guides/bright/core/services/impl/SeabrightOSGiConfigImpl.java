...
@Component(service = SeabrightOSGiConfig.class,immediate = true)
@Designate(ocd = SeabrightOSGiConfigImpl.ServiceConfig.class )
public class SeabrightOSGiConfigImpl implements SeabrightOSGiConfig{

    @ObjectClassDefinition(name="SeaBright - New OSGi Configuration",
            description = "OSGi Configuration For SeaBright.")
    public @interface ServiceConfig {
        ...
        public String serviceName() default "SeaBright Service";
